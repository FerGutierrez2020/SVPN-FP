**************************************************************************************************
La siguiente práctica tiene como objetivo configurar FlexVPN Hub to Spoke usando valores por default 
en Routers CSRV1k con IKEv2
by Fer Gutierrez
...
FlexVPN
========
!!!!!a. Create an IKEv2 profile and assign the keyring.
!
...
exit
!
!!!!!Configure the virtual-template 3 as type tunnel. Reference the interface as an IP unnumbered address and apply the IPsec profile
!
int virtual-template 3 type tunnel
